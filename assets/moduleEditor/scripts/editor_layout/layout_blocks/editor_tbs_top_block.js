...
class EditorTbsTopBlock{
	#created_elem;#edt_tb_inserts;
	#edt_tb_1;#edt_tb_2;#edt_tb_3;
	#edt_tb_4;#edt_tb_5;#edt_tb_6;
	#items_wrapper;	#new_parent; #present_parent;
	...
	insert_toolbar = async (obj_args)=>{
		...
		if(this.#present_parent !== null){
			...
			el_data.elem_id = edt_tb_id;
			el_data.elem_classes = edt_tb_classes;
			this.#created_elem = edt_tb_cb(el_data);
