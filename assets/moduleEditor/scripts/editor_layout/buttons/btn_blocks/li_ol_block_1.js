//buttons/btn_blocks/li_ol_block_1.js
import * as MFT from './../../../factory/module_functions.js';
import * as BEE from './../btn_elems_export.js';
export async function liOlBlock_1(...args){
	const [icon_option]= args;
	const icon = icon_option ? icon_option : 'li-ol-icon-1';
	const elem_data = await MFT.createObjects('block_obj',{});
	elem_data.block_btn = {};
	elem_data.block_btn.elem_id = 'li_ol_block_1';
	...
	elem_data.btn = {};
	elem_data.btn.elem_id = 'li_ol_btn_1';
	elem_data.btn.elem_classes = ['tb-item','tb-style',icon,'relative'];
	elem_data.btn.elem_title = 'Nummeric';
