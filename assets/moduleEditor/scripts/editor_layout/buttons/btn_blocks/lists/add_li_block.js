...
export async function addLiBlock(...args){
	const [prt_tag,icon_option]= args;
	const icon = icon_option ? icon_option : 'add-list-icon';
	const elem_data = await MFT.createObjects('el_obj',{});
	elem_data.block_btn = {
		elem_id: 'li_block',
