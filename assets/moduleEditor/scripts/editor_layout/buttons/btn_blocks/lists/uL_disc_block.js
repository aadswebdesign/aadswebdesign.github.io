//buttons/btn_blocks/lists/ul_disc_block.js
import * as MFT from './../../../../factory/module_functions.js';
import * as EFE from './../../../elems_factory_export.js';
export async function ulDiscBlock(...args){
	const [icon_option]= args;
	const icon = icon_option ? icon_option : 'disc-icon';
	const elem_data = await MFT.createObjects('block_obj',{});
	elem_data.block_btn = {};
	elem_data.block_btn.elem_id = 'ul_disc_block';
	...
	elem_data.btn = {};
	elem_data.btn.elem_id = 'ul_disc_btn';
	...
	return parent_el;		
	//console.table({'ulDiscBlock': args});
}