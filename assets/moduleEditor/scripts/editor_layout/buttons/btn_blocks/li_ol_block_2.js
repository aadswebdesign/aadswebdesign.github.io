//buttons/btn_blocks/li_ol_block_2.js
import * as MFT from './../../../factory/module_functions.js';
import * as EFE from './../../elems_factory_export.js';
export async function liOlBlock_2(...args){
	const [icon_option]= args;//O 
	const icon = icon_option ? icon_option : 'li-ol-icon-2';
	...
	elem_data.btn.elem_title = 'Alpha Lowercase';
