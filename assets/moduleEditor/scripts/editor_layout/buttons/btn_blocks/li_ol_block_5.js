//buttons/btn_blocks/li_ol_block_5.js
import * as MFT from './../../../factory/module_functions.js';
import * as EFE from './../../elems_factory_export.js';
export async function liOlBlock_5(...args){
	const [icon_option]= args;
	const icon = icon_option ? icon_option : 'li-ol-icon-5';
	const elem_data = await MFT.createObjects('block_obj',{});
	elem_data.block_btn = {};
	elem_data.block_btn.elem_id = 'li_ol_block_5';
	...
	elem_data.btn = {};
	elem_data.btn.elem_id = 'li_ol_btn_5';
	elem_data.btn.elem_classes = ['btn-style','tb-item',icon,'relative'];
	elem_data.btn.elem_title = 'Roman Uppercase';
