// editorManager/factory/insert_self_closing_block.js
import * as MFT from './module_functions.js';
import * as MDFT from './module_dom_functions.js';
class InsertSelfClosingBlock{
	...
	constructor(...args){
		...
		//console.table({'insertSelfClosingBlock': args});
	}
}
export const insertSelfClosingBlock = async (...args)=>{
	return new InsertSelfClosingBlock(...args);
};		