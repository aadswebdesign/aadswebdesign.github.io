// editor_logic/events/ruler_on_event.js
			...
			if(this.#parent_el !== null && this.#target_el !== null ){
				const evt_manipulator= async(evt)=>{
					...
					if(this.#parent_el.hasAttribute('data-on')){
						this.#target_el.innerText = '❌';
						this.#target_el.title = 'Close Buttons Left';
						this.#target_el.style.cursor = 'pointer';
					}
				};
...
export const rulerOnEvent = async (...args)=>{
	return new RulerOnEvent(...args);
};	