...
class CommandsData{
	#left_ctn;	#parent_ctn;	#right_ctn;
	#tbx_ctn_data;	create_block;	count;
	ctn_strip;	tbx_block;	tbx_close;
	tbx_command_data;	tbx_content;
	constructor(obj_args){
		...
		const{tbx_ctn,tbx_close,ctn_strip,count} = this.#tbx_ctn_data;
		...
		(async()=> {
			this.create_block = async(...args) => {
				...
				this.tbx_command_data.tbx_el = tbx_el;
