// actions/block_tf_off_action.js
import * as MFT from './../../factory/module_functions.js';
import * as MDFT from './../../factory/module_dom_functions.js';
import {actionOffCs} from './constructs/action_off_cs.js';
class BlockTfOffAction{
	#canvas_el;	#pre_el; #pre_outer;
	#pre_output;#tag_name;
	constructor(obj_args){
		const {canvas_el,pre_el,pre_output,pre_outer,el_name,tag_name} = obj_args;
		...
		//console.table({'BlockTfOffAction': obj_args});
	}
}
export const blockTfOffAction = async (obj_args)=>{
	return new BlockTfOffAction(obj_args);
}