//scripts/editor_logic/modules/blocks/list_mdls/li_ol_mdl_5.js
...
export const liOlModule_5 = async (...args)=>{
	...
	//console.table({'liOlModule_5': args});
}
