// editor_logic/modules/set_block_textformat_mdl.js
...
export const setBlockTextformatMdl = async (...args)=>{
	return new SetBlockTextformatMdl(...args);
};