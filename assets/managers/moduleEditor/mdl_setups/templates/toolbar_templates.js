//moduleEditor/mdl_setups/templates/toolbar_templates.js
...
export const itemsWrapperTemplate = (...args) =>{
	...
	const tpl = `
		<items-wrapper class='${wrapper_class} relative display-flex'>
			<items-button class='triangle-left-icon-editor-8x8 relative' data-tb_open='' title='close this'></items-button>
