...
export function h1Template(){
	return btnTpl('h1_block','heading','h1_btn','h1-icon-24x24','Heading 1 (swipe for other headings!)');
}
export function h2Template(){
	return btnTpl('h2_block','heading','h2_btn','h2-icon-24x24','Heading 2 (swipe for other headings!)');
}
export function h3Template(){
	return btnTpl('h3_block','heading','h3_btn','h3-icon-24x24','Heading 3 (swipe for other headings!)');
}
export function h4Template(){
	return btnTpl('h4_block','heading','h4_btn','h4-icon-24x24','Heading 4 (swipe for other headings!)');
}
export function h5Template(){
	return btnTpl('h5_block','heading','h5_btn','h5-icon-24x24','Heading 5 (swipe for other headings!)');
}
export function h6Template(){
	return btnTpl('h6_block','heading','h6_btn','h6-icon-24x24','Heading 6 (swipe for other headings!)');
}
