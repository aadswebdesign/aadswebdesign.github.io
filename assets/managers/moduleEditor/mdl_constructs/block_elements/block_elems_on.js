					...
					if(this.#editor_el.lastElementChild !== null){
						...
						if(this.last_child.tagName === 'ARTICLE'){
							...
							if(this.parent_el.lastElementChild !== null){
								...
								DFT.isPreviousElem(this.parent_el,'ARTICLE-HEADER',this.#br_el); 
								DFT.isPreviousElem(this.parent_el,'HR',this.#br_el); 
								DFT.isPreviousElem(this.parent_el,'P',this.#br_el); 
							}
						}
					}
				}
					...
					if(this.#editor_el.lastElementChild !== null){
						...
						if(this.last_child.tagName === 'ARTICLE'){
							...
							if(this.parent_el.lastElementChild !== null){
								...
								DFT.isPreviousElem(this.parent_el,'ARTICLE-MAIN',this.#br_el); 
								DFT.isPreviousElem(this.parent_el,'HR',this.#br_el); 
								DFT.isPreviousElem(this.parent_el,'P',this.#br_el); 
							}
						}
					...
					if(this.#editor_el.lastElementChild !== null){
						...
						if(this.last_child.tagName === 'ARTICLE'){
							...
							if(this.parent_el.lastElementChild !== null){
								...
								DFT.isPreviousElem(this.parent_el,'ARTICLE-FOOTER',this.#br_el); 
								DFT.isPreviousElem(this.parent_el,'HR',this.#br_el); 
								DFT.isPreviousElem(this.parent_el,'P',this.#br_el); 
							}
						}
