...
class HeadingsElemsCallback{
	...
	headings_on_cb = (el_construct)=>{
		...
		(async ()=>{
			...
			await MC.btnManipulator(h1_block,await events_manipulator);
		})();
		(async ()=>{
			async function events_manipulator(evt){
			...
			await MC.btnManipulator(h2_block,await events_manipulator);
		})();
		(async ()=>{
			async function events_manipulator(evt){
			...
			await MC.btnManipulator(h3_block,await events_manipulator);
		})();
		(async ()=>{
			async function events_manipulator(evt){
			...
			await MC.btnManipulator(h4_block,await events_manipulator);
		})();
		(async ()=>{
			async function events_manipulator(evt){
			...
			await MC.btnManipulator(h5_block,await events_manipulator);
		})();
		(async ()=>{
			async function events_manipulator(evt){
			...
			await MC.btnManipulator(h6_block,await events_manipulator);
		})();
	};
	...
	items_ruler_cb = (el_construct)=>{
		(async ()=>{
			...
			await MC.btnManipulator(items_ruler,await events_manipulator);
		})();		
	};
}
export const headingsElemsCallback = async (obj_args)=>{
	return new HeadingsElemsCallback(obj_args);
};
