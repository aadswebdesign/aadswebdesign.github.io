/**localhost  modules/mdl_factory/action_functions.js */
import * as FT from './../../factory/functions.js';
export const locationsManager = async (menus)=>{
	...
	const [menu_item_three_1] = menu_items_three;
	const [menu_item_four_1,menu_item_four_2] = menu_items_four;
	...
	switch(loc){
		case '/aadswebdesign/#home':{
			...
			await FT.removeClass(menu_item_four_2,'active');
		...
		case '/aadswebdesign/#projects/#editor':
			...
			await FT.removeClass(menu_item_four_2,'active');
		break;		
		case '/aadswebdesign/#topics2/#one':
			...
			await FT.removeClass(menu_item_four_2,'active');
		break;		
		case '/aadswebdesign/#topics3/#one':
		...
		case '/aadswebdesign/#learnings/#selectionrange':
			await FT.addClass(menu_item_four_2,'active');
			await FT.removeClass(menu_default,'active');
			await FT.removeClass(menu_item_one_1,'active');
			await FT.removeClass(menu_item_two_1,'active');
			await FT.removeClass(menu_item_three_1,'active');
