...
export const landingTemplateActions = async ()=>{
	const asp_ratio1 = await SE.setSvgAspRatio('xMidYMid',true);
	const asp_ratio2 = await SE.setSvgAspRatio('xMidYMid');
	const my_person = await './assets/graphics/images/my_person.jpg';
	return await landingTemplate().then(()=>{
		...
		const svgArgs = {
			...
			svg2:{viewBox:'-20 -20 520 540 ',width:'100%',height:'100%'},
			...
			text1:{x:'175',y:'200',textLength:'120',lengthAdjust:'spacingAndGlyphs'},
			...
			text5:{x:'0',y:'40',textLength:'100',lengthAdjust:'spacingAndGlyphs'},
			text6:{x:'300',y:'40',textLength:'200',lengthAdjust:'spacingAndGlyphs'},
			textPath2:{href:'#textPathTwo'},
			textPath3:{href:'#textPathThree'},
			textPath4:{href:'#textPathFour'},
		};
		SE.svg('awd-svg absolute', 'landingPageSvg',null,null,null,'.landing-template',false,true);
		SE.svgDefs(null,null,null,null,null,'#landingPageSvg');
		/** Defs vanillePattern block */
		SE.svgLinearGradient(null,'vanillaGradient',{...svgArgs.gradient1},null,null,'defs');
		SE.svgStop(null,null,{...svgArgs.stop1},null,null,'#vanillaGradient');
		SE.svgStop(null,null,{...svgArgs.stop2},null,null,'#vanillaGradient');
		SE.svgStop(null,null,{...svgArgs.stop3},null,null,'#vanillaGradient');
		SE.svgPattern(null,'vanillePattern',{...svgArgs.pattern1},null,null,'defs');
		SE.svgPath(null,null,{...svgArgs.path1},null,null,'pattern');
		/** Defs landing block */
		SE.svgLinearGradient(null,'landingGradient',{...svgArgs.gradient2},null,null,'defs');
		SE.svgStop(null,null,{...svgArgs.stop1},null,null,'#landingGradient');
		SE.svgStop(null,null,{...svgArgs.stop2},null,null,'#landingGradient');
		SE.svgStop(null,null,{...svgArgs.stop3},null,null,'#landingGradient');
		/** Defs textpath block */
		SE.svgPath(null,'textPathTwo',{...svgArgs.text_path2},null,null,'defs');
		SE.svgPath(null,'textPathThree',{...svgArgs.text_path3},null,null,'defs');
		SE.svgPath(null,'textPathFour',{...svgArgs.text_path4},null,null,'defs');
		
		/** Shapes vanillePattern block */
		SE.svgGroup('group-one',null,null,null,null,'#landingPageSvg');
		SE.svgRect(null,null,{...svgArgs.rect1},null,null,'g.group-one');
		/** Shapes landing block */
		SE.svg('awd-svg inner absolute', null,{...svgArgs.svg2},null,null,'#landingPageSvg',false,true);
		SE.svgGroup('group-two',null,null,null,null,'svg.awd-svg.inner');
		SE.svgPath(null,null,{...svgArgs.path2},null,null,'g.group-two');
		SE.svgRect('img-frame',null,{...svgArgs.rect2},null,null,'g.group-two');
		SE.svgImage(null,null,{...svgArgs.img1},null,null,'g.group-two');
		SE.svgGroup('group-three',null,null,null,null,'svg.awd-svg.inner');
		SE.svgText('text-string one',null,{...svgArgs.text1},'Welcome', null,'g.group-three');
		SE.svgText('text-string two',null,{...svgArgs.text2},null, null,'g.group-three');
		SE.svgText('text-string three',null,{...svgArgs.text3},null, null,'g.group-three');
		SE.svgText('text-string four',null,{...svgArgs.text4},null, null,'g.group-three');
		SE.svgTextPath('text-path two',null,{...svgArgs.textPath2},'CSS SVG',null, 'text.text-string.two')
		SE.svgTextPath('text-path three',null,{...svgArgs.textPath3},'JAVASCRIPT',null, 'text.text-string.three')
		SE.svgTextPath('text-path four',null,{...svgArgs.textPath4},'HTML',null, 'text.text-string.four')
		SE.svgText('text-string five',null,{...svgArgs.text5},'ALL', null,'g.group-three');
		SE.svgText('text-string six',null,{...svgArgs.text6},'VANILLA', null,'g.group-three');
	});
};
