/* eslint-disable
    ...
    no-var,
*/
import { NON_BREAKING_SPACE } from "./../constants.js"
...
import { findInnerElement, getTextConfig, makeElement } from "./../core/helpers/index.js"
  ...
  createElement() {
    ...
    for (key in this.attributes) {
      ...
      if (config) {
        if (config.tagName) {
          var innerElement
          const pendingElement = makeElement(config.tagName,{class:`piece-view`})
