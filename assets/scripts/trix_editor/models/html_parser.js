...
import BasicObject from "./../core/basic_object.js"
...
export default class HTMLParser extends BasicObject {
  ...
  createHiddenContainer() {
    if (this.referenceElement) {
      ...
      this.containerElement.setAttribute("class", "html-parcer-refered")
	  this.containerElement.style.display = "none"
      return this.referenceElement.parentNode.insertBefore(this.containerElement, this.referenceElement.previousSibling)
    } else {
      const container_element = makeElement({ tagName: "div", style: { display: "none",class: 'html-parcer-non-refered' } })
	  this.containerElement = container_element
  ...
  getMarginOfDefaultBlockElement() {
    const element = makeElement(config.blockAttributes.default.tagName,{class:`html-parcer`, tabindex: '-1'})
