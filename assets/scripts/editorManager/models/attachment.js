...
import ImagePreloadOperation from "./../operations/image_preload_operation.js"
export default class Attachment extends TpObject {
    ...
    getFormattedFilesize() {
        ...
        if (typeof filesize === "number") {
            return CI.fileSize.formatter(filesize)
        } else {
            return ""
        }
    }
