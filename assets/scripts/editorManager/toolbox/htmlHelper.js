/** assets/scrips/editorManager/toolbox/html_base.js */
export function createHtmlHelper(_elem, _class, _id, _atts, _content, _tpl,_parent, _el_query = true, _replace, log = false){ //
	...
	if(_parent){
		...
		if(null !== __parent){
			return __parent.appendChild(_el);
		}
		if(_replace){
