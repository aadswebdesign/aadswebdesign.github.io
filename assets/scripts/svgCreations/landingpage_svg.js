...
export const svgLandingPage360 = async ()=>{
	const svgArgsInner = {
		/** Defs landing objects */
	...
	/** Shapes landing block */
	await SE.svg('awd-svg inner match-360 absolute', null,{...svgArgsInner.svg2},null,null,'#svgPlaceholderOne',false);
	await SE.svgGroup('group-three',null,null,null,null,'svg.awd-svg.inner.match-360');
	...
	await SE.svgGroup('group-four',null,null,null,null,'svg.awd-svg.inner.match-360');
...
export const svgLandingPage360non = async ()=>{
	const svgArgsInner = {
		/** Defs landing objects */
		svg2:{viewBox:'-22 -20 520 540 ',width:'100%',height:'100%'},
		gradient2:{gradientTransform:'rotate(90)'},
	...
	await SE.svgStop(null,null,{...svgArgs.stop3},null,null,'#landingGradient');
	/** Shapes landing block */
	await SE.svg('awd-svg inner non-match-360 absolute', null,{...svgArgsInner.svg2},null,null,'#svgPlaceholderOne',false);
	await SE.svgGroup('group-three',null,null,null,null,'svg.awd-svg.inner.non-match-360');
	await SE.svgPath(null,null,{...svgArgs.path2},null,null,'g.group-three');
	await SE.svgRect('img-frame',null,{...svgArgs.rect2},null,null,'g.group-three');
	await SE.svgImage(null,null,{...svgArgs.img1},null,null,'g.group-three');
	/** Shapes text block */
